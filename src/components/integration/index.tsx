      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="flex-1 w-full max-w-lg">
            <div className="glass-card rounded-xl p-6 relative">
                ...
                <div className="font-mono text-xs md:text-sm leading-7 text-zinc-500">
                    <div className="text-zinc-600">
                        &lt;! -- QueryNow -- &gt;

                    </div>
                    <div>
                         &lt;<span className="text-pink-600">script</span>&gt;

                    </div>
                    <div className="pl-4">
                        <span className="text-indigo-400">src</span>
                        <span className="text-emerald-400">
                            &quot;https://querynow.com/init.js&quot;
                        </span>
                    ...
                    <div className="pl-4">
                        ...
                        <span className="text-emerald-400">
                            &quot;a171d969-ac84-4275-9bc0-4818556df543&quot;
                        </span>
                        <br />
